...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("    <body>\n");
      out.write("        <div class=\"py-5 text-center text-white h-100 align-items-center d-flex\" style=\"background-image: linear-gradient(to bottom, rgba(0, 0, 0, .75), rgba(0, 0, 0, .75)), url(https://static.pingendo.com/cover-bubble-dark.svg);  background-position: center center, center center;  background-size: cover, cover;  background-repeat: repeat, repeat;\" >\n");
      out.write("            <div class=\"container py-5\">\n");
      out.write("                <div class=\"row\">\n");
      out.write("                    <div class=\"mx-auto col-lg-8 col-md-10\">\n");
      out.write("                        <h1 class=\"display-3 mb-4\">Lorry Reservation System</h1>\n");
      out.write("                        <p class=\"lead mb-5\">We delivered the system that user can book and reserve lorry for deliveries, moving house with the many types of lorry&nbsp;</p> <a href=\"signup.jsp\" class=\"btn btn-lg btn-primary mx-1\">Sign Up</a> <a class=\"btn btn-lg mx-1 btn-outline-primary\" href=\"login.jsp\">Login</a>\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
      out.write("        <div class=\"py-5 text-center text-white align-items-center d-flex h-25\" style=\"background-image: linear-gradient(to bottom, rgba(0, 0, 0, .75), rgba(0, 0, 0, .75)), url(https://static.pingendo.com/cover-bubble-dark.svg);  background-position: center center, center center;  background-size: cover, cover;  background-repeat: repeat, repeat;\"></div>\n");
