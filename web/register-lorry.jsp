<%-- 
    ...
    Created on : 20 Jun 2022, 3:17:58 am
    Author     : HP
--%>
            ...
            <div class="container">
                <div class="row">
                    <div class="mx-auto col-md-8 text-center" style="">
                        ...
                        <form action="<%=request.getContextPath()%>/BookingServlet" method="POST">
                            <input type="hidden" name="command" value="ADDLORRY"/>
                ...
                <div class="row">
                    <div class="mx-auto p-4 col-lg-7" style="">
                        <form style="">
                            <h1 class="text-center" style="">Book your lorry</h1>
                            ...
                            <br>
                            <div class="row">
                                <div class="col-md-12 text-center"><input type="submit" class="btn text-center w-25 btn-dark" value="Book"/><input type="reset" class="btn text-center w-25 btn-dark" value="Cancel" onclick="window.location.href = '<%=request.getContextPath()%>/BookingServlet?command=LISTLORRY&lorryCusId=<%=cusId%>'"/></div>
                            </div>
                    </div>
                </div>
